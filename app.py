...
def add_subject():
    ...
    if request.method == "POST":
        ...
        return redirect(f"/add_unit/{subject_id}")
...
@app.route("/add_unit/<int:sid>", methods=["GET", "POST"])
def add_unit(sid):
    ...
    if request.method == "POST":
        ...
        return redirect(f"/add_material/{unit_id}")

    return render_template("add_unit.html", sid=sid)


# ---------------- ADD MATERIAL ----------------

@app.route("/add_material/<int:uid>", methods=["GET", "POST"])
def add_material(uid):
    ...
    if request.method == "POST":
        ...
        return redirect(f"/add_quiz/{uid}")

    return render_template("add_material.html", uid=uid)


# ---------------- ADD QUIZ ----------------

@app.route("/add_quiz/<int:uid>", methods=["GET", "POST"])
def add_quiz(uid):
    ...
    return render_template("add_quiz.html", uid=uid)
